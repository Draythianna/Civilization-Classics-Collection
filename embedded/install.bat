...
echo a | %civmain%\7z x Civ2UIA.v1.21.5.2785.zip -o"%CivPath%\Civilization II Multiplayer Gold Edition\"
...
echo a | %civmain%\7z x Civ2MGE_v19.7z -o"%CivPath%\Civilization II Multiplayer Gold Edition\"
