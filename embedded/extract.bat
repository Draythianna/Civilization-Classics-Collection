...
set "drive=%Civ1Data%"
for %%i in ("%drive%") do if /I "%%~xi"==".zip" goto civd
for %%i in ("%drive%") do if /I "%%~xi"==".rar" goto civd
for %%i in ("%drive%") do if /I "%%~xi"==".7z.exe" goto civd
set "drive=%Civ1Drive%"
...
for %%i in ("%drive%") do if /I "%%~xi"==".zip" goto civnc
for %%i in ("%drive%") do if /I "%%~xi"==".rar" goto civnc
for %%i in ("%drive%") do if /I "%%~xi"==".7z.exe" goto civnc
...
set "drive=%Civ2Data%"
for %%i in ("%drive%") do if /I "%%~xi"==".zip" goto civ2d
for %%i in ("%drive%") do if /I "%%~xi"==".rar" goto civ2d
for %%i in ("%drive%") do if /I "%%~xi"==".7z.exe" goto civ2d
set "drive=%Civ2Drive%"
...
for %%i in ("%drive%") do if /I "%%~xi"==".zip" goto civtd
for %%i in ("%drive%") do if /I "%%~xi"==".rar" goto civtd
for %%i in ("%drive%") do if /I "%%~xi"==".7z.exe" goto civtd
